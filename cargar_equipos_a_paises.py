...
equipos_espanoles = ['Atlético de Madrid', 'FC Barcelona','Real Madrid','Athletic Club','Real Betis','Celta Vigo','RCD Espanyol','RCD Mallorca','Real Sociedad','Valencia CF']  # Lista de equipos españoles
